            ...
            <div class="pull-right beta-components space-left ov">
                ...
                <div class="beta-comp">
					...
					<div class="beta-comp">
                        ...
                        <div class="beta-select"><i class="fa fa-shopping-cart" id='total'>{{$a_count}}</i>
                                                     San Pham
							...
							<div class="beta-dropdown cart-body"  >
                                    <div id="giohang">
                                        @foreach (Cart::Content() as $item)
                                            <div class="cart-item">
                                                <a href="{{Route('xoagiohang',$item->rowId)}}" class="cart-item-delete"><i class="fa fa-times"></i></a>
                                                <div class="media">
								...
								<div class="cart-caption">
									<div class="cart-total text-right" >Tổng tiền:  <span class="cart-total-value" id="tongtien">{{$b_price}}</span></div>
									<div class="clearfix"></div>
